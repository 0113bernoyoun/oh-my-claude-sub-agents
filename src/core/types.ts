...
export type PromptOutputMode = 'inline' | 'external';
...
export const OMCSA_EXTERNAL_FILENAME = 'omcsa-agents.md';
export const OMCSA_IMPORT_DIRECTIVE = '@omcsa-agents.md';
export const CLAUDE_MD_SIZE_WARNING_BYTES = 15000;
